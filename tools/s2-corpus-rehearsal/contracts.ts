...
export type AttemptLeaseDisposition = 'no-retained-terminal-attempt-lease' | 'retained-terminal-attempt-recovery-required' | 'retained-terminal-attempt-reconciled';
