...
export const D65_GRAPH_PUBLICATION_FIELDS: readonly (keyof D65GraphPublication)[] = Object.freeze([
...
export function parseD65GraphPublication(value: unknown): D65GraphPublication {
  ...
  const record = object(value, label, [...D65_GRAPH_PUBLICATION_FIELDS] as string[]);
