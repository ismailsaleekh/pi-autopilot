...
/**
 * Closed, audited patch-build lineage for the protocol-1.3/schema-9 wire
...
export const COORDINATOR_WIRE_COMPATIBILITY_MATRIX = Object.freeze([
  Object.freeze({ package_build: '1.0.1-cf38', protocol_version: '1.3', database_schema_version: 9, lifecycle_lock_schema: CURRENT_COORDINATOR_LIFECYCLE_LOCK_SCHEMA }),
  Object.freeze({ package_build: '1.0.2-cf39', protocol_version: '1.3', database_schema_version: 9, lifecycle_lock_schema: CURRENT_COORDINATOR_LIFECYCLE_LOCK_SCHEMA }),
  Object.freeze({ package_build: '1.0.3-cf40', protocol_version: '1.3', database_schema_version: 9, lifecycle_lock_schema: CURRENT_COORDINATOR_LIFECYCLE_LOCK_SCHEMA }),
] as const);
