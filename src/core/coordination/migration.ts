...
async function acquireMigrationLock(stateRoot: string, path: string, afterBoundary?: (boundary: CoordinationMigrationCrashBoundary) => void | Promise<void>): Promise<CoordinationMigrationOperationLock> {
