...
import {
  ...
  type CoordinationExclusiveOperationKind,
} from './types.ts';

export const COORDINATION_EXCLUSIVE_MAX_EXPECTED_DURATION_MS = 300_000;

export type CoordinationRuntimeExclusiveOperationKind = Exclude<CoordinationExclusiveOperationKind, 'legacy-migration-exclusive'>;

export interface CoordinationExclusiveOperationInput {
 ...
 */
export function coordinationExclusiveOperation(input: CoordinationExclusiveOperationInput): CoordinationExclusiveOperation {
...
export function legacyMigrationExclusiveOperation(operationId: string): CoordinationExclusiveOperation {
...
export function assertExactExclusiveRepositoryPath(path: string): void {
