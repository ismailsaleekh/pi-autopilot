...
import { appendClaimEvent, coordinationRootForRepo, readActiveAutopilots, readPathClaims, readUnitIndex, resolveRepoIdentity, taskRootForActiveAutopilot, writeJsonAtomic, writePathClaims, type AutopilotPathClaim, type ProcessEnvLike } from './parallel-runtime.ts';
