...
- Child statuses belong under \`${input.runtimeRoot}/statuses/\`, receipts under \`${input.runtimeRoot}/receipts/\`, runner-produced execution audits under \`${input.runtimeRoot}/execution-audits/\`, execution-commit evidence under \`${input.runtimeRoot}/execution-commits/\`, runtime-owned unit merge evidence under \`${input.runtimeRoot}/unit-merges/\`, and stale-validation blockers under \`${input.runtimeRoot}/validation-staleness/\`.
