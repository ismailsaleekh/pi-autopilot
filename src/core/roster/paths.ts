...
// Workstream-run identities include the canonical UTC launch timestamp suffix
// generated by buildAutopilotWorkstreamRun (e.g. `...-20260722T220032Z-...`).
// Unlike roster/repo storage ids, this segment therefore legitimately contains
// uppercase `T` and `Z`. Keep the grammar closed to ASCII alnum + hyphen and the
// existing 120-byte ceiling, but accept the production identity bytes instead
// of rejecting every real timestamped launch run.
