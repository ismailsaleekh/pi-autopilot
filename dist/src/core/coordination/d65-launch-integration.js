 ...
 */
export function verifyLaunchManifestAgainstClone(manifest) {
    ...
    // The sealed launch-audit and bootstrap-projection evidence must exist with the
    // exact sealed digests (immutable external launch-audit authority).
...
async function acceptSignedGraphHeartbeat(input) {
    ...
    const acceptedSequence = typeof head === 'object' && head !== null ? head['sequence'] : null;
