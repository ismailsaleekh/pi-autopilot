import { decideS2CoordinationFailure } from "./s2-failure-taxonomy.js";
...
function sanitizeS2DiagnosticText(value, maximumCodePoints) {
    ...
    if (points.length <= maximumCodePoints)
        return { text: withoutLabeledSecrets, redacted, omitted_code_points: 0 };
...
function boundedS2Evidence(values) {
    const output = [];
...
export function buildS2CoordinationFailureDiagnostic(input) {
...
export function buildS2CoordinationRuntimeErrorDiagnostic(error) {
