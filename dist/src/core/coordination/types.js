...
export const COORDINATION_OPERATION_TYPES = ['create', 'materialize', 'commit', 'merge', 'reset', 'quarantine', 'archive', 'remove', 'metadata-reconcile'];
...
export const COORDINATION_INTEGRATION_CONFLICT_KINDS = ['legacy-conservative', 'disjoint-hunks', 'clean-overlap', 'textual-merge-conflict', 'delete-modify-conflict', 'protected-surface-conflict', 'semantic-key-conflict'];
export const COORDINATION_INTEGRATION_DISPOSITIONS = ['ordered-integration', 'repair-required'];
export const COORDINATION_MERGE_TREE_STATUSES = ['clean', 'conflict', 'legacy-unverified'];
