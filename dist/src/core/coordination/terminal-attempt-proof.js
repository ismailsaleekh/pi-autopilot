...
import { parseAutopilotEventRow, parseAutopilotExecutionAudit, parseAutopilotReceipt, parseAutopilotStatusEntry, parseAutopilotUnitSpec } from "../contracts/index.js";
...
export function proveStructuredAttemptTerminal(input) {
    ...
    try {
        ...
        if (spec.workstream !== input.workstream || spec.unit_id !== input.unitId || spec.attempt !== input.attempt)
