...
export function validCoordinationSnapshot(): CoordinationSnapshot {
  ...
  return {
    ...
    session_leases: [
      ...
      { schema_version: 'autopilot.session_lease.v1', session_lease_id: 'session-lease-b', repo_id: 'repo-1', workstream_run: 'run-b', session_id: 'session-b', session_generation: 1, pid: 102, boot_id: 'boot-b', lease_expires_at: '2026-07-11T16:00:00.000Z', status: 'attached', attached_event_seq: 2, version: 1 },
    ],
    ...
    acquisition_groups: [
      { schema_version: 'autopilot.acquisition_group.v1', acquisition_group_id: 'group-a', owner: ownerA, requested_leases: [{ path: 'src/shared.ts', mode: 'WRITE', purpose: 'implement shared source' }], state: 'granted', created_event_seq: 2, grant_event_seq: 3, offer_expires_at: null, bypass_count: 0, version: 2 },
      { schema_version: 'autopilot.acquisition_group.v1', acquisition_group_id: 'group-b', owner: ownerB, requested_leases: [{ path: 'src/shared.ts', mode: 'WRITE', purpose: 'implement peer change' }], state: 'waiting', created_event_seq: 3, grant_event_seq: null, offer_expires_at: null, bypass_count: 0, version: 1 },
    ],
    ...
    messages: [{ schema_version: 'autopilot.coordination_message.v1', message_id: 'message-request-a', repo_id: 'repo-1', recipient_workstream_run: 'run-a', message_type: 'claim-request', correlation_id: 'request-b-a', status: 'delivered', created_event_seq: 3, delivered_event_seq: 3, acknowledged_event_seq: null, version: 2 }],
