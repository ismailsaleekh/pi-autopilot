// Sharded 5-client persistent release-trace cohort (Phase 40 / D70 C3+C4).
...
void describe('coordinator multiprocess lifecycle', () => {
  ...
  void it(`runs the seeded reproducible 5-client persistent randomized release trace`, async () => {
    await certifyPersistentReleaseTrace(5);
  });
});
