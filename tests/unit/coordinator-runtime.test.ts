...
void describe('transactional coordinator runtime', () => {
  ...
  void it('never reclaims a live lifecycle PID because boot identity differs', async () => {
    ...
    const live = { schema_version: 'autopilot.coordinator_lock.v2', pid: process.pid, boot_id: 'deliberately-wrong-boot', process_start_identity: identity, token: 'live-token', instance_id: 'live-instance', package_build: '1.0.2-cf39', protocol_version: '1.3', database_schema_version: 9, started_at: '2026-07-13T00:00:00.000Z' };
